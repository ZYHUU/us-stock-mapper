...
| 发布版本 | 内部代号 | 训练记录 | 状态 |
| --- | --- | --- | --- |
| [`v0.1.0`](../../releases/tag/v0.1.0) | `classic-lr-v6` | [`experiments/2026-08-24-frozen-test-and-privacy-fix`](experiments/2026-08-24-frozen-test-and-privacy-fix/) | **当前发布版本**，`experimental`（见 [Model Card](model_cards/company-matcher-v0.1.0.md)），正式线上基线 |
